...
public class Test5 {
    ...
    public static void main(String[] args) {
        ...
        //score = new Score4(); // 파라미터 값을 받는 생성자 이다.
                                // 파라미터 값을 넘기지 않고 호출할 수 없다.
        
        //score = new Score4("홍길동"); //생성자를 호출할 떄 
                                                     //반드시 생성자에 정의된 파라미터의 타입과 개수, 순서가 같아야한다.    
        ...
        //
        //score = new Score3("홍길동"); //Score3()에는 문자열을 받는 생성자가 없다 컴파일 오류!
