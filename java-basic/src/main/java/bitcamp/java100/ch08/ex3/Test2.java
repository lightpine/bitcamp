// 오버라이딩 사용 후
// Score2 클래스는 수퍼클래스 Object로부터 상속받은 toString메서드를 재정의하였다.
// => 이렇게 상속받은 메서드를 서브 클래스의 역할에 맞춰 재정의 하는것을
//    "오버라이딩"이라 부른다.
...
public class Test2 {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Score2는 Object의 toString을 재정의 하였기 때문에
            // 다음 코드에서 호출되는 것은 재정의된 toString이다.
