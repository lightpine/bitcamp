...
public class Array {
    ...
    // 배열을 1개만 만들어서 순차적으로 사용할 것 같으면 static 으로 만들면 된다.
    ...
    // 개발자가 여러개의 주소를 다루기 위해 특별히 고안한 메모리 구조이다.
    // 새로운 타입을 정의하면 그 타입에 데이터를 다루는 연산자가 필요하다.
    // 다음은 이 타입의 데이터를 다루는 연산자를 정의한 것이다.
