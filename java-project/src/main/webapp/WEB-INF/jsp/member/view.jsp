...
<div class='col-sm-10'>
<input readonly class='form-control' id='no' type='number' name='no' value='${member.no}'>
</div>
</div>
...
<div class='col-sm-10'>
<input class='form-control' readonly id='regdate' type='date' value='${member.createdDate}'>
</div>
</div>
...
<a href='delete?no=${member.no}' class='btn btn-outline-info btn-sm'>삭제</a>
</div>
</div>
</form>
</c:if>
