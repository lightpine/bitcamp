...
<div class='form-group row'>
<label for='file1' class='col-sm-2 col-form-label'>사진1</label>
<div class='col-sm-10'>
...
<div class='form-group row'>
<label for='file2' class='col-sm-2 col-form-label'>사진2</label>
<div class='col-sm-10'>
...
<div class='form-group row'>
<label for='file3' class='col-sm-2 col-form-label'>사진3</label>
<div class='col-sm-10'>
