...
// 함수를 전달할 때 단 한번만 사용할 함수라면 익명함수를 정의하여 그 주소를 전달하라.
// 자바스크립트도 자바처럼 주고 받는것은 주소값이다~~!!
play(10, 20, function plus(a, b) {console.log(a, '+', b, '=', a + b)})
play(10, 20, function minus(a, b) {console.log(a, '-', b, '=', a - b)})

try{
plus(15, 25) // 오류! 함수를 호출할 때 아규먼트 자리에서 정의한 함수는 
             // 따로 사용할 수 없다.
