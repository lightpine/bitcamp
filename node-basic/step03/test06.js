...
// 프로퍼티 이름 중에 공백이나 특수문자가 포함되어 있지 않다면,
// 다음과 같이 작성할 수 있다.
// 객체명.프로퍼티명
...
// 다음과 같이 조건문에 객체의 프로퍼티를 지정하여 존재여부를 검사할 수 있다.
// 그런데 만약 해당 변수의 값이 false라면 존재하지 않는걸로 오해할 수 있기 때문에
...
// => obj에 plus라는 이름의 값이 들어있지 않다면 undefined를 리턴한다.
//    그런데 undefined는 조건식에서 false 값으로 자동 형변환 한다. 
if (obj.plus) {
    obj.plus(10, 20)
}
